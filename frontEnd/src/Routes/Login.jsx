...
const Login = () => {
  ...
  const validationSchema = Yup.object().shape({
    email: Yup.string().email('Correo inválido').required(<Typography className="alert">Ingresá tu correo registrado</Typography>),
    password: Yup.string().required(<Typography className="alert">Ingresá tu contraseña</Typography>),
  });

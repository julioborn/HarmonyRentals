...
const Footer = () => {
    ...
    const appImageUrl = 'images/footerlogo.png'; // Reemplaza '/images/app-image.png' con la ruta de la imagen de tu aplicación
                ...
                <Box className='boxFoot1'>
                    <Box className='footer-left'>
                        <Box className='logo-foot'>
                            <Avatar src='images/footerlogo.png' sx={{ width: '40px', height: '40px' }} />
                        </Box>

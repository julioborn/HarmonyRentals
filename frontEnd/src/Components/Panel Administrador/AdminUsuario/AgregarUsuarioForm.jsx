                ...
                <Paper sx={{ padding: "5vh" }}>
                  ...
                  <Grid container spacing={2}>
                   ...
                   <Grid item xs={12} sm={6}>
                      ...
                      <FormControl fullWidth sx={{ mb: 1 }}>
                        <Field as={TextField} id="dni" name="dni" type="number" size="small" error={errors.dni && touched.dni} />
                        {errors.dni && touched.dni && <FormHelperText>{errors.dni}</FormHelperText>}
                      </FormControl>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <InputLabel htmlFor="telefono">Teléfono</InputLabel>
                      <FormControl fullWidth sx={{ mb: 1 }}>
                        <Field as={TextField} id="telefono" name="telefono" type="number" size="small" error={errors.telefono && touched.telefono} />
                        {errors.telefono && touched.telefono && <FormHelperText>{errors.telefono}</FormHelperText>}
                      </FormControl>                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <InputLabel htmlFor="domicilio">Domicilio</InputLabel>
                      <FormControl fullWidth sx={{ mb: 1 }}>
                        <Field as={TextField} id="domicilio" name="domicilio"  size="small" error={errors.domicilio && touched.domicilio} />
                        {errors.domicilio && touched.domicilio && <FormHelperText>{errors.domicilio}</FormHelperText>}
                      </FormControl>
                    </Grid>

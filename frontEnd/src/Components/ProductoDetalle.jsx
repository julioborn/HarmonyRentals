...
import PreviewRentar from "../Components/Reserva/PreviewRentar";
...
const ProductoDetalle = () => {
  ...
  const [verRentarProductoComponent, setVerRentarProductoComponent] = useState(false);
  const previewRentarRef = useRef(null);
      ...
      <Box className="contex-detalle">
        <Paper className="paper" sx={{ boxShadow: "0 0 2px 2px #8f8f8f88" }}>
          ...
          >
              ...
              >
                ...
                >
                  ...
                  <Typography
                    ...
                    align="justify"
                    sx={{
                      mt: "1vh", width: "100%", color: "#737270", letterSpacing: "0.05em", // adjust the value as needed
                      lineHeight: "1.5"
                    }}
                  >
                    {product.descripcion}
                  ...
                  >
                    <Typography variant="h6" sx={{ color: "#737270", mt: "2vh" }}>
                      Valor diario:
                    </Typography>
                    <Typography variant="h6" sx={{ color: "#16213e", mt: "2vh" }}>
                      {" "}
                  ...
                  >
                    ...
                    <Typography sx={{ color: "#16213e", fontSize: 45 }}>
                      {puntaje}
                    </Typography>
            ...
            <Box
            className="botonesReservarConfirmar"
              sx={{                
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
            ...
            >
              <Button
                onClick={() => navigate(`/reservar/${product.id}`)}
                variant="contained"
                className="btn-add"
                sx={{
                  display: "flex",
          ...
          >
            ...
            <Box className="poli-fecha" sx={{ display: "flex", alignItems: "top", justifyContent: "center", gap: 5 }}>
              {verRentarProductoComponent && (
                <Box sx={{}}>
                  <PreviewRentar
                    producto={product}
              ...
              {!verRentarProductoComponent && <Box className="policies">
                <PoliciesList />
              </Box>}
              <Box>
                <Box className="text-fecha">
                  <Typography
                    variant="h5"
                    id="disponible"
                    sx={{ mt: "5px", pb: "4px", letterSpacing: "3px", lineHeight: "1.5" }}
                  >
                    Fechas Disponibles
                  </Typography>
                </Box>
